...
//
// Regenerate with: dart run tool/generate_backward.dart
// Source: https://data.iana.org/time-zones/tzdb/{backward,etcetera}

/// The tzdb release [backwardLinks] was generated from.
const String backwardTzdbVersion = '2026c';

/// Deprecated IANA identifiers mapped to current primary names.
///
/// Taken verbatim from the database, so every target is a
/// primary zone name.
const Map<String, String> backwardLinks = {
